# Repository settings proposal for burin-labs/harn-confluence-connector
...
`harn-confluence-connector` is a Harn connector package for confluence. It is public so that
